-- COMPLETE FIX: This script will properly recreate all campaign tables
-- It handles existing tables and ensures all column types match
...
-- Step 3: Drop all campaign-related tables (in correct order due to dependencies)
...
-- Step 5: Create campaigns table with INT (matching users.id)
...
-- Step 6: Create campaign_recipients table
...
-- Step 7: Create campaign_tracking table
...
-- Step 9: Show table structures to confirm
