-- FINAL FIX: Create campaigns tables with proper foreign key handling
-- This script ensures all tables are dropped and recreated with matching types
...
-- Step 2: Drop foreign key constraints first (if they exist)
SET FOREIGN_KEY_CHECKS = 0;

-- Step 3: Drop campaign tables if they exist
